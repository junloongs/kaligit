...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "单向配置核查工具"))

        self.pushButton.setText(_translate("MainWindow", "选取表格文件(可多选)"))
        ...
        self.actionshijunlong1031_qq_com.setText(_translate("MainWindow", "请保证所选表格中列名称包含[本端基站ID]与[对端基站ID]"))
